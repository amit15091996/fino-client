...
export const menuItemStyle={fontSize:12,fontWeight:"900"}
const MenuProps = {PaperProps: {style: { maxHeight: ITEM_HEIGHT * 4.5 + ITEM_PADDING_TOP}, }};
 ...
 const CustomDropDown=({label,children,value,onChange,isFullwidth,placeholder,isRequired})=>{
  ...
  return (
   ...
   sx={{"&.MuiInputLabel-sizeSmall": {fontWeight:"900",top:"0vh",marginLeft:0,fontSize:11,left:0,padding:0,alignItems:"center"}
  ,"&.MuiInputLabel-shrink":{
    ...
    sx={{height:33,fontSize:11,fontWeight:"900"}}
    MenuProps={MenuProps}
     id={`${label}-1`}
      value={value}
      onChange={onChange}
