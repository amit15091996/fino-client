  ...
  return (
    <Box sx={{mt:1}}>
     ...
     <Box sx={{mr:1,...GlobalStyles.alignmentStyles_2}}>
        <CustomButton variant={"contained"}  onClick={depositOnclick} color={"secondary"} title={"ADD"}/>
       </Box>

        <Box sx={{mt:1,mr:1}}>
        <CustomTable TableName={"CMS TRANSACTION"} onEditClick={onUpdateClick} headCells={FinoLabel.bankDepositTableHead} onDeleteClick={onDepositDelete} rows={bankDepositData} isActionRequired={true} />
        </Box>
