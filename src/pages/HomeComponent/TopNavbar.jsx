import { Avatar, Box, Card, Grid, IconButton, ListItemIcon, Menu, MenuItem, Typography } from '@mui/material'
...
<Menu
        ...
        PaperProps={{elevation: 0,
          sx:{
            overflow: 'visible', filter: 'drop-shadow(0px 2px 8px rgba(0,0,0,0.32))', mt: 1.5,width:140,
