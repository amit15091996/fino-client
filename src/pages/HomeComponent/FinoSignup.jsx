...
const FinoSignup = ({ }) => {
    ...
    return (
        <Box sx={{ maxWidth: 370,height:"100%",display:"flex",alignItems:"center",p:1.5}} >
            ...
            <Box sx={{border: `1px solid ${GlobalStyles.sideTopNavborderColor}`, m: 1.5, borderRadius: 1.5, p:1}}>
...
<Box sx={{p:1,mt:1,...GlobalStyles.alignmentStyles}}>
        <CustomButton endIcon={<FaArrowUpRightFromSquare  />} color={"p1"} isFullwidth={true} title={FinoLabel.signUp}/>
       </Box>
            </Box>
